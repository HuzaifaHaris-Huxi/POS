...
export default function NewBankAccount() {
    ...
    const submit = async (e) => {
        ...
        setSaving(true);
        try {
            await axios.post(`${API}/api/finance/accounts/create/`, form, { withCredentials: true });
            navigate('/finance/accounts');
        } catch (e) {
            alert(e.response?.data?.error || 'Failed to register account.');
        } finally {
            setSaving(false);
        }
    };
            ...
            <div className="bg-white border-b border-gray-300 px-8 h-16 flex items-center justify-between shrink-0 z-50">
                <div className="flex items-center gap-6">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-sm font-black text-gray-900 tracking-tight leading-none mb-1">Source Registration</h1>
                            <p className="text-[9px] font-black text-gray-300 uppercase tracking-widest leading-none tracking-tighter">Finance Infrastructure v2.1</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex items-center gap-2 px-4 py-2 bg-gray-50 rounded-xl border border-gray-300">
                    ...
                    <span className="text-[9px] font-black text-gray-400 uppercase tracking-widest">Awaiting Input</span>
                </div>
            </div>
                ...
                <div className="w-full max-w-4xl bg-white rounded-[40px] shadow-[0_40px_100px_rgba(0,0,0,0.06)] border border-gray-100 flex flex-col md:flex-row overflow-hidden min-h-[600px]">
                    ...
                    <div className="w-full md:w-[300px] bg-gray-900 p-12 flex flex-col justify-between relative overflow-hidden shrink-0">
                        <div className="relative z-10">
                            ...
                            <h2 className="text-2xl font-black text-white tracking-tight leading-[1.1] mb-4">Registering New Finance Source</h2>
                            <p className="text-[11px] font-medium text-gray-400 leading-relaxed">Ensure every bank account is tied to a specific branch for accurate transaction tracking and branch-level ledgers.</p>
                        </div>
